                                ...
                                bareWorkItemWidgets =
                                    BareWorkItemWidgets(
                                        ...
                                        onWorkItemWidgetLabels =
                                            BareWorkItemWidgets.OnWorkItemWidgetLabels(
                                                labels =
                                                    BareWorkItemWidgets.Labels(
                                                        __typename = "",
                                                        nodes =
                                                            labels
                                                                .shuffled()
                                        ...
                                        onWorkItemWidgetAssignees =
                                            BareWorkItemWidgets.OnWorkItemWidgetAssignees(
                                                assignees = null,
                                            ),
                                        onWorkItemWidgetTimeTracking =
                                            BareWorkItemWidgets.OnWorkItemWidgetTimeTracking(
                                                timelogs =
                                                    BareWorkItemWidgets.Timelogs(
                                                        __typename = "",
                                                        nodes =
                                                            timelogs
                                                                .shuffled()
                                                                .take(Random.nextInt(0, timelogs.size))
